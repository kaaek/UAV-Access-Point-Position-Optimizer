...
[uav_pos_grid, br_grid, sumlink_mbps_grid] = gridSol(user_pos, M, N, AREA, H, K, GAMMA, D_0, P_T, P_N, BW_total);
...
[uav_pos_random, baseline_br, sumlink_mbps_random] = randomSol(user_pos, M, N, AREA, H, K, GAMMA, D_0, P_T, P_N, BW_total, Rmin);
...
uav_pos_gs_kmeans   = optimizeUAVPositions(N, AREA, uav_pos_kmeans, user_pos, H, K, GAMMA, D_0, P_T, P_N, BW_total, Rmin); % Outputs Nx2 matrix
uav_pos_gs_grid     = optimizeUAVPositions(N, AREA, uav_pos_grid, user_pos, H, K, GAMMA, D_0, P_T, P_N, BW_total, Rmin); % Outputs Nx2 matrix
uav_pos_gs_random   = optimizeUAVPositions(N, AREA, uav_pos_random, user_pos, H, K, GAMMA, D_0, P_T, P_N, BW_total, Rmin); % Outputs Nx2 matrix
...
[~, br_kmeans, sumlink_mbps_fm_kmeans]   = optimizeBandwidthAllocation(M, BW_total, user_pos, uav_pos_gs_kmeans, H, K, GAMMA, D_0, P_T, P_N, Rmin);
[~, br_grid, sumlink_mbps_fm_grid]       = optimizeBandwidthAllocation(M, BW_total, user_pos, uav_pos_gs_grid, H, K, GAMMA, D_0, P_T, P_N, Rmin);
[~, br_random, sumlink_mbps_fm_random]   = optimizeBandwidthAllocation(M, BW_total, user_pos, uav_pos_gs_random, H, K, GAMMA, D_0, P_T, P_N, Rmin);
